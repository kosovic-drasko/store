...
import static store.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import store.config.Constants;
import store.domain.User;
import store.repository.AuthorityRepository;
import store.repository.UserRepository;
import store.security.AuthoritiesConstants;
import store.service.UserService;
import store.service.dto.AdminUserDTO;
import store.service.dto.PasswordChangeDTO;
import store.service.dto.UserDTO;
import store.web.rest.vm.KeyAndPasswordVM;
import store.web.rest.vm.ManagedUserVM;
